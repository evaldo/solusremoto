...
//altera_cores.php
	session_start();
	$_SESSION['id_menu_sist_pts']=$_POST['id_menu_sist_pts'];
							...
							<div class="table-responsive">  							
								<table class="table table-bordered">			
									 <tr>  
										...
										<td style="width:150px"><p class="form-control-static" name="id_menu_sist_pts"><?php echo $_POST['id_menu_sist_pts']; ?></p>
										</td>  
									 </tr>
									  <tr>  
										<td style="width:150px"><label>Nome do Menu:</label></td>  
										<td style="width:400px"><input type="text" class="form-control" name="nm_menu_sist_pts" value="<?php echo $row[1]; ?>"></td> 							
									  </tr>									  
									  <tr>  
