...
//altera_cores.php
	session_start();
	$_SESSION['id_status_equipe']=$_POST['id_status_equipe'];
	
    include '../database.php';	
	
	$pdo = database::connect();

	$sql = "SELECT id_status_equipe, id_equipe, ds_status_equipe, fl_ativo, fl_status_intrpe_trtmto_equipe, fl_status_finaliza_trtmto_equipe, cd_cor_status_equipe from tratamento.tb_c_status_equipe where id_status_equipe = ".$_SESSION['id_status_equipe']."";
		...
		<div class="container" style="width: 100%;  margin-right: 0; margin-left: 0; position: relative;">
		  <div class="modal-dialog">
				<div class="modal-content" style="width:800px">
					<div class="container">						
						<h4 class="modal-title">Alteração do Status da Equipe</h4>
					</div>								
						...
						<div class="modal-body">
							<div class="table-responsive">  							
								<table class="table table-bordered">
									 <tr>  
										<td style="width:150px"><label>Id Status da Equipe:</label></td>  
										<td style="width:150px"><p class="form-control-static" name="id_status_equipe"><?php echo $id_status_equipe; ?></p>
										</td>  
									 </tr>
									 <tr>  
										<td style="width:150px"><label>Descrição do Status:</label></td>  
										<td style="width:200px"><input type="text" class="form-control" name="ds_status_equipe" value="<?php echo $ds_status_equipe; ?>"></td>  
									 </tr>
									 ...
									 <tr>  
										...
										<td style="width:200px"><input type="text" class="form-control" name="cd_cor_status_equipe" value="<?php echo $cd_cor_status_equipe; ?>"></td>  
									 </tr>
								</table>																
							</div>								
