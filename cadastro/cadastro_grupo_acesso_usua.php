<?php
	...
	if(isset($_POST['deleta'])){					
		...
		{	
			// remove do banco			
			$sql = "DELETE FROM tratamento.tb_c_grupo_usua_acesso WHERE id_grupo_usua_acesso = ".$_SESSION['id_grupo_usua_acesso']."";	
	...
	if(isset($_POST['insere'])){					
		...
		{	
			...
			$sql="select count(1) from tratamento.tb_c_grupo_usua_acesso where id_grupo_acesso = ".$_POST['id_grupo_acesso']." and cd_usua_acesso = ".$_POST['cd_usua_acesso']."";
