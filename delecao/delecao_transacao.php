						...
						<div class="table-responsive">  
							<table class="table table-bordered">
								 <tr>  
									...
									<td width="500%"><?php echo $_POST['id_acesso_transac_integracao']; ?></td>  
								 </tr>
								 <tr>  
									<td width="50%"><label>Nome do Menu/Funcionalidade:</label></td>  
									<td width="500%"><?php echo $_POST['nm_menu_sist_integracao']; ?></td>  
								 </tr>								 
								 <tr>  
								 ...
								 <tr>  
									...
									<td width="500%"><?php echo $_POST['cd_transac_integracao']; ?></td>  
								 </tr>
								 <tr>  
									<td width="50%"><label>Cód da Func/Menu no Integração:</label></td>  
									<td width="500%"><?php echo $_POST['cd_form_transac_integracao']; ?></td>  
								 </tr>
							</table>
						</div>
					</div>
