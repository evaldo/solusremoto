		...
		<div class="container" style="width: 100%;  margin-right: 0; margin-left: 0; position: relative;">
		  <div class="modal-dialog">
				<div class="modal-content" style="width:800px">
					<div class="container">						
						<h4 class="modal-title">Inserção de Grupos de Acesso</h4>
					</div>								
						...
						<div class="modal-body">
							<div class="table-responsive">  							
								<table class="table table-bordered">									 									  
									  <tr>  
										<td style="width:150px"><label>Nome do Grupo de Acesso:</label></td>  
										<td style="width:200px"><input type="text" class="form-control" name="nm_grupo_acesso"></td>  
									 </tr>
								</table>																
							</div>								
