		...
		<div class="container" style="width: 100%;  margin-right: 0; margin-left: 0; position: relative;">
		  <div class="modal-dialog">
				<div class="modal-content" style="width:800px">
					<div class="container">						
						<h4 class="modal-title">Inserção de Grupos x Usuários</h4>
					</div>								
					<form class="form-inline" method="post" id="formulario">
							...
							<div class="table-responsive">
								<table class="table table-bordered">									 									  
									 ...
									 <tr>  
										...
										?>
										<td style="width:150px">
											<select  class="form-control" id="uacesso" onchange=" 
														var selObj = document.getElementById('uacesso');
														var selValue = selObj.options[selObj.selectedIndex].value;
														document.getElementById('cd_usua_acesso').value = selValue;">
											<option value="N"></option>
											<?php
												$cont=1;										
												while($row = pg_fetch_row($ret)) {
						...
						<input type="text" id="cd_usua_acesso" name="cd_usua_acesso" style="display:none"> 
					</form>
				</div>
			</div>
		</div>		
