		...
		<div class="container" style="width: 100%;  margin-right: 0; margin-left: 0; position: relative;">
		  <div class="modal-dialog">
				<div class="modal-content" style="width:800px">
					<div class="container">						
						<h4 class="modal-title">Inserção do Status da Equipe</h4>
					</div>								
							...
							<div class="table-responsive">
								<table class="table table-bordered">									 
									    ...
									    <tr>  
											...
											<td style="width:200px"><input type="text" class="form-control" name="ds_status_equipe"></td>  
									 </tr>	
									 ...
									 <tr>  
											...
											<td style="width:200px"><input type="text" class="form-control" name="cd_cor_status_equipe"></td>  
									 </tr>	
