...
//insercao_usuario.php
	...
	$sql = "SELECT id_status_trtmto, ds_status_trtmto, cd_cor_status_trtmto from tratamento.tb_c_status_trtmto  order by 1";
		...
		<div class="container" style="width: 100%;  margin-right: 0; margin-left: 0; position: relative;">
		  <div class="modal-dialog">
				<div class="modal-content" style="width:800px">
					<div class="container">						
						<h4 class="modal-title">Inserção do Status de Tratamento</h4>
					</div>								
